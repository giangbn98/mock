...
public class ImagesController {
    ...
    public ResponseEntity<BaseResultDTO> findAll(@RequestParam("pageSize") Integer pageSize, @RequestParam("page") Integer page){
        BaseResultDTO result = imagesService.findAll(pageSize, page);
        return new ResponseEntity<>(result,HttpStatus.OK);
    }
    @RequestMapping(value = "/image",method = RequestMethod.POST)
    public ResponseEntity<BaseResultDTO> addImage(@RequestParam("file") MultipartFile file, HttpServletRequest request){
